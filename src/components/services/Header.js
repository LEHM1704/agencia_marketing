...
function Header(){
    ...
    return(
        ...
        <div className="relative px-6 lg:px-8 ">
          <div className="mx-auto max-w-full mx-12 xl:pt-40 xl:pb-64 lg:pt-40 lg:pb-48 pt-24 pb-12">
            <div>
              <div>
                ...
                <p className="mt-16 text-2xl leading-8 text-black">
                  We love to shake established thought-patterns and create what has 
                  never been attempted before. We takehas never attempted before. We take seeds and grow jungles
                </p>
              </div>
