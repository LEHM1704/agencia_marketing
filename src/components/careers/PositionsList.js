...
function PositionsList(){
    return(
        <div className="max-w-full mx-12 bg-white">
            ...
            <p className="text-2xl font-regular text-gray-900 mx-w-5xl leading-10">Lest's write some beautiful code and make smart designs. This is what we're crazy about, adn we're looking for the ones who feel the same</p>
